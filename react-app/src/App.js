...
class App extends Component {
    ...
    onFinalised = text => {
        ...
        if (text.includes("light") && text.includes("on")) {
            ...
            // response = "I'll toggle the lights";
        }
        ...
        if (text.includes("temperature") && text.includes("to") && text.split(" ").indexOf("to") < text.split(" ").length - 1) {
            try {
                ...
                // response = "I'll set the temperature to " + parseInt(text.split(" ")[text.split(" ").indexOf("to") + 1]);
            } catch (e) {
        ...
        //     response = "What can I say except your welcome";
